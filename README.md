...
```
Bike station data that is made publicly available by the ([city of Chicago](https://www.chicago.gov/city/en/narr/foia/data_disclaimer.html)) will also be used. It can be downloaded here ([here](https://data.cityofchicago.org/Transportation/Divvy-Bicycle-Stations/bbyy-e7gq/data))https://data.cityofchicago.org/Transportation/Divvy-Bicycle-Stations/bbyy-e7gq/data. In terms of bias and credibility, both data sources we are using ROCCC:
